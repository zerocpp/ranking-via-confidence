...
for prev_name in ${prev_names[@]}; do
  for dataset_name in ${dataset_names[@]}; do
    ...
    DEVICE=cuda:$cuda python gen.py --model Qwen/Qwen2.5-7B-Instruct --dataset_jsonl_path /mnt/sda/song/rerank/dataset/$dataset_name-$prev_name-top10.jsonl --output_dir /mnt/sda/song/rerank/gen/qwen7b/$dataset_name --num_generations 10
  done
done
